    ...
    <form action="{{ route('contacts.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="form  p-4 ">
            <div class="flex-1">
                ...
                <a class=" normal-case text-2xl font-bold text-[#002D4B]">New contact</a>
        ...
        <div class="flex gap-2 p-10 mx-auto rounded-lg">
            ...
            <div class='grid w-full bg-gray-200 p-10  rounded-xl gap-3'>
                ...
                <div class="grid w-full">
                    ...
                    <input placeholder="" maxlength="255" minlength="5" name="name" type="text" title="Escreva no mínimo 5 caracteres" class="bg-gray-50 outline-0 rounded shadow p-2 {{ $errors->has('name') ?  'input input-bordered input-error' : '' }}" />
                </div>
                
                <div class="grid w-full">
                    <label class="font-medium ">Contact</label>
                    <input placeholder="" type="number" name="contact" minlength="9" maxlenght="9" class="bg-gray-50 outline-0 rounded shadow p-2 {{ $errors->has('contact') ?  'input input-bordered input-error' : '' }}" />
                </div>
